...
const { ensureDir, writeGeneratedFile } = require("./reportFiles");
const { buildTestHistory, phaseTimingEntries } = require("./reportModel");
const { statusClass } = require("./reportNavigation");
...
module.exports = { writeTestHtmlPages };
